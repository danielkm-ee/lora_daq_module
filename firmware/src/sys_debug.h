...
/*enabling RTC_OUTPUT should be set via STM32CubeMX GUI because MX_RTC_Init is
 * now entirely generated */

#elif defined(PROBE_PINS_ENABLED) &&                                           \
    (PROBE_PINS_ENABLED == 0) /* PROBE_PINS_OFF */
...
/*disabling RTC_OUTPUT should be set via STM32CubeMX GUI because MX_RTC_Init is
 * now entirely generated */
 ...
 * @note  When in Dual Core DbgMcu pins should be better disable only after CM0+
 * is started
 */
